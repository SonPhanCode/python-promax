...
def spam():
	check = 0
	if nd1() != " " and nd2() != " " and nd3() != " ":
		check =1
	else:
		messagebox.showinfo("Lỗi", """Cả 3 nội dung không được để trống!!!""")
	n= sl()
	m = dotregiay()
	if n != 0 and check ==1:
...
# so lan spam
solan = Entry(form,font=("Conslas",20),border =5,bg = "white")
solan.focus()
...
noidung1 = Text(form,font=("Conslas",20), border = 5,bg = "white")
...
noidung2 = Text(form,font=("Conslas",20),border = 5,bg = "white")
...
noidung3 = Text(form,font=("Conslas",20),border = 5,bg = "white")
...
# do tre (giay)
sogiay = Entry(form,font=("Conslas",20),border = 5,bg = "white")
...
#nhap toa do X
nhapx = Entry(form,font=("Conslas",20),border = 5,bg = "white")
...
y.place(x= 400, y=685)
#nhap toa do Y
nhapy = Entry(form,font=("Conslas",20),border = 5,bg = "white")
