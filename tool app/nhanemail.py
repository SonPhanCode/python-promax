...
def process():
	...
	headers.update({'Referer' : 'https://temp-mail.io'}) #https://temp-mail.io
	...
	res= ses.post('https://api.internal.temp-mail.io/api/v2/email/new', headers=headers, data= postdata)
