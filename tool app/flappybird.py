...
pygame.display.set_caption('TRUONGDZ')
         ...
         for event in pygame.event.get():
            ...
            if event.type==pygame.KEYDOWN:
               if event.key==pygame.K_RETURN:
                  wait=0
         self.msg("dung lai",dw-100,dh-100,blue,40)
         pygame.display.flip()
   def over(self):
      wait=1
      self.gover=1
      while wait:
         for event in pygame.event.get():
            ...
            if event.type==pygame.KEYDOWN:
               if event.key==pygame.K_RETURN:
                  wait=0
         self.msg("ban da thua",dw-150,dh-100,blue,40)
         self.msg("an phim enter de choi lai",dw-445,dh+200,blue,40)
         pygame.display.flip()
      self.new()
   def scores(self):
