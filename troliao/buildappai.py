...
Y = 500
z=850
Imghead= pygame.transform.scale(pygame.image.load('E:/hocpython/bgr.png'),(z,z))
bg=pygame.transform.scale(pygame.image.load('bgr.png'),(z,z))
...
while True:
	...
	textRect = text.get_rect()  	
	textRect.center = (X // 2, Y // 2)
	gameSurface.blit(bg,pygame.Rect(0,0,z,z))
	...
	if "không cần nữa" in you2 or "Không cần nữa" in you2 :
		...
		#print("Ok!Bye")
	elif "alo" in you2 or "hello" in you2:
		ai= "ờ em đây"
		output = gTTS(ai,lang="vi", slow=False)
		output.save("file.mp3")
		playsound.playsound('file.mp3')
