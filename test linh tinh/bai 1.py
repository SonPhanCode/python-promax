"""def soluong(ngay,luong):
        if ngay>=25:
                ...
                print(luong)
def main():
        ngay=int(input("nhap so ngay lam: "))
        luong=0
        print(soluong(ngay,luong))
if __name__ == '__main__':
        main()         
"""
"""
s = "(205650,50465543530)"
p =[]
...
def tab3():
        tk2 = Tk()
        tk2.title("TRẠNG THÁI")
        tk2.geometry('200x200+0+0')
        btn = Button(tk2,text="DỪNG LẠI",width =38,height= 10,font=("san-serif",20,"bold"))
        btn.pack()
        tk2.mainloop()
#ham cua tab 2
# tab moi
